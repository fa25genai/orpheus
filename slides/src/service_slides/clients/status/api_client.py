...
import service_slides.clients.status.models
from service_slides.clients.status import rest
from service_slides.clients.status.api_response import ApiResponse
from service_slides.clients.status.api_response import T as ApiResponseT
from service_slides.clients.status.configuration import Configuration
from service_slides.clients.status.exceptions import ApiException, ApiValueError
...
class ApiClient:
    ...
    def param_serialize(self, method, resource_path, path_params=None, query_params=None, header_params=None, body=None, post_params=None, files=None, auth_settings=None, collection_formats=None, _host=None, _request_auth=None) -> RequestSerialized:
    ...
    async def call_api(self, method, url, header_params=None, body=None, post_params=None, _request_timeout=None) -> rest.RESTResponse:
        ...
        try:
            ...
            response_data = await self.rest_client.request(method, url, headers=header_params, body=body, post_params=post_params, _request_timeout=_request_timeout)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(service_slides.clients.status.models, klass)
