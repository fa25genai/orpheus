...
class ListSlidesets200ResponseInner(BaseModel):
    """
    ListSlidesets200ResponseInner
    """ # noqa: E501
    prompt_id: StrictStr = Field(alias="promptId")
    created_at: datetime = Field(alias="createdAt")
    __properties: ClassVar[List[str]] = ["promptId", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSlidesets200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSlidesets200ResponseInner from a dict"""
        if obj is None:
            return None
