...
class RequestSlideGenerationRequest(BaseModel):
    ...
    """ # noqa: E501
    course_id: StrictInt = Field(description="Numerical identification of the course for which slides should be generated ", alias="courseId")
    lecture_id: Optional[StrictInt] = Field(default=None, description="Numerical identification of the lecture to which the slides will belong. ", alias="lectureId")
    concept: StrictStr = Field(description="Plain text containing the details of the lecture (including examples and explanations). May have any format (i.e. human readable). ")
    user: Optional[Dict[str, Any]] = Field(default=None, description="Schemaless additional information about the user (e.g. preferences regarding slide style).")
    ...
    __properties: ClassVar[List[str]] = ["courseId", "lectureId", "concept", "user", "assets"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "user": obj.get("user"),
            "assets": [RequestSlideGenerationRequestAssetsInner.from_dict(_item) for _item in obj.get("assets")] if obj.get("assets") is not None else None
        })
        return _obj
