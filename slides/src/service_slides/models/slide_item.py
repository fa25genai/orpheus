...
class SlideItem(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="Human readable text, describing which lecture contents will be contained in the slide")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SlideItem from a JSON string"""
