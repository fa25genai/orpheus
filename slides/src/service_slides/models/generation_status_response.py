...
class GenerationStatusResponse(BaseModel):
    ...
    total_pages: Optional[StrictInt] = Field(default=None, description="Total amount of pages that have to be generated", alias="totalPages")
    generated_pages: Optional[StrictInt] = Field(default=None, description="Amount of generated pages at the last point of update", alias="generatedPages")
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    error: Optional[Error] = None
    __properties: ClassVar[List[str]] = ["lectureId", "status", "totalPages", "generatedPages", "lastUpdated", "error"]
