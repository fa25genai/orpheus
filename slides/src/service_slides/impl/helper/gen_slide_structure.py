...
from service_slides.impl.llm_chain.slide_structure import DetailedSlideStructure, generate_slide_structure
from service_slides.impl.manager.layout_manager import LayoutDescription
from service_slides.impl.mock.slide_mock_objects import make_mock_slide_structure
...
async def generate_slide_structure_or_mock(
    ...
    if ORPHEUS_DEBUG:
        ...
        return await generate_slide_structure(
