...
def make_mock_slide_structure() -> DetailedSlideStructure:
    mock_items = [
        DetailedSlideStructureItem(
            content="Title: Introduction to For Loops\nHello, and welcome! Today, we're going to dive into the world of 'for loops' in Python. "
                    "Now, you might be wondering, what *is* a for loop? Simply put, a for loop is a control flow statement that allows us to repeatedly execute a block of code.",
            layout="default",
        ),
        DetailedSlideStructureItem(
