...
class UploadAcceptedResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["promptId", "createdAt", "webUrl", "pdfUrl"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UploadAcceptedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UploadAcceptedResponse from a dict"""
        if obj is None:
            return None
