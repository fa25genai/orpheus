...
import VideoSkeleton from "./skeletons/video-skeleton";
...
export default function VideoPlayer({
  ...
  const nextSource = sources[currentIndex + 1]?.url;
        ...
        >
          ...
          {[0, 1].map((i) => (
            <video
              ...
              src={active === i ? currentSource : nextSource || ""}
              autoPlay={active === i}
              preload="auto"
              onEnded={handleEnded}
            />
