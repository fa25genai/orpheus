...
def summarize_content_with_llama(
    ...
    prompt = f"Summarize the following content in 3-4 sentences. Only return the summary with respect to user query, do not preface with any explanation or heading and return \"Query irrelevant to course content\" if its unrelated.\n\n{text_content}\n\nUser prompt: {user_prompt}"
