...
from service_core.models.docint.image_object import ImageObject
try:
...
class RetrievalResponse(BaseModel):
    ...
    RetrievalResponse
    """ # noqa: E501
    content: List[StrictStr] = Field(description="Array of text snippets.")
    images: List[ImageObject] = Field(description="Array of image objects.")
    __properties: ClassVar[List[str]] = ["content", "images"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RetrievalResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RetrievalResponse from a dict"""
        if obj is None:
            return None
