...
class AvatarAudioResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "avatarId", "filePath", "mimeType", "sizeBytes", "createdAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvatarAudioResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvatarAudioResponse from a dict"""
        if obj is None:
            return None
