...
| **Slide Push Service**        | Uploads generated slides to the `Generated Avatar Delivery` (CDN) for distribution.                                      | TODO gather info                                                                                                                                                                                                                                                                                   |
...
| **Video Push Service**        | Uploads generated avatar videos to the `Generated Slide Delivery` (CDN) for distribution.                                | TODO gather info                                                                                                                                                                                                                                                                                   |
